...
<html>
    <head></head>
    <body>
      Products in grid: <xsl:value-of select="count(catalog/item[season='Fall'] | catalog/item[season='Spring, Summer, Fall'] | catalog/item[season='Spring, Fall'] | catalog/item[season='Spring, Fall, Winter'] | catalog/item[season='Fall, Winter'])"/>
        ...
        <table border="1">
          <tr bgcolor="#eaeff7" height="55px">
            ...
            <xsl:for-each select="catalog/item[season='Fall'] | catalog/item[season='Spring, Summer, Fall'] | catalog/item[season='Spring, Fall'] | catalog/item[season='Spring, Fall, Winter'] | catalog/item[season='Fall, Winter']">
        <tr>
          <a>
