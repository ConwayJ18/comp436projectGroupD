...
<html>
    <head></head>
    <body>
      Products in grid: <xsl:value-of select="count(catalog/item[occasion='Formal'] | catalog/item[occasion='Casual, Formal'] | catalog/item[occasion='Formal, Casual'])"/>
        ...
        <table border="1">
          <tr bgcolor="#eaeff7" height="55px">
            ...
            <xsl:for-each select="catalog/item[occasion='Formal'] | catalog/item[occasion='Casual, Formal'] | catalog/item[occasion='Formal, Casual']">
        <tr>
